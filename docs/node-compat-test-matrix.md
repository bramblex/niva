...
- The README documents branch/option limits that are not shown as exhaustively
  ...
  cases; missing Web Crypto/compression APIs; and HTTP redirect/private-address/
  status edge cases.
