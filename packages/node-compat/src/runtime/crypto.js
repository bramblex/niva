(function (root) {
  ...
  function timingSafeEqual(a, b) {
    ...
    if (typeof runtime.callSync !== "function" || !root.Niva) {
      throw cryptoError("Synchronous timingSafeEqual is unavailable in this page", "ENOTSUP");
    }
    return !!runtime.callSync(root.Niva, "os.timingSafeEqual", [left.toString("base64"), right.toString("base64")]);
  }
