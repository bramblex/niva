(function (root) {
  ...
  function typeError(argument, expectation, value, prefix) {
    var error = new TypeError((prefix || "The \"" + argument + "\" argument must be ") + expectation + ". " + valueDescription(value));
  ...
  Buffer.copyBytesFrom = function (view, offset, length) {
    ...
    var elementCount = view.length;
    var bytesPerElement = view.BYTES_PER_ELEMENT;
