(function (root: any) {
  ...
  Object.defineProperty(AssertionError, "name", { configurable: true, value: "AssertionError" });
  Object.defineProperty(Comparison, "name", { configurable: true, value: "Comparison" });
  ...
  function matchesExpected(error, expected, result: any = {}) {
  ...
  Object.defineProperty(throws, "name", { configurable: true, value: "throws" });
  Object.defineProperty(doesNotThrow, "name", { configurable: true, value: "doesNotThrow" });
  ...
  Object.defineProperty(rejects, "name", { configurable: true, value: "rejects" });
  Object.defineProperty(doesNotReject, "name", { configurable: true, value: "doesNotReject" });
