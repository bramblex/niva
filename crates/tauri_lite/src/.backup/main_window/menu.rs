use crate::{environment::{ProjectOptions }, window_manager::MenuConfig};
use wry::application::menu::{MenuBar, MenuId, MenuItem, MenuItemAttributes};

pub fn create(config: &ProjectOptions) -> Option<MenuBar> {
...
#[cfg(target_os = "macos")]
fn create_default_menu(config: &ProjectOptions) -> (String, MenuBar) {
